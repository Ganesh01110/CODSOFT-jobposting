    ...
    <div className='container mx-auto flex flex-col gap-8 2xl:gap-14 py-6 '>
      <div className='w-full flex flex-col-reverse md:flex-row gap-10 items-center p-5'>
        <div className='w-full md:2/3 2xl:w-2/4'>
          ...
          Welcome to Jobi-Fy: Your Gateway to Talent and Opportunity!

          At Jobi-Fy, we believe in the power of connections. We understand that
      ...
      <div className='leading-8 px-5 text-justify'>
        ...
        <p>
        At the heart of Jobi-Fy is a commitment to simplifying the hiring process, making it more efficient, transparent, 
        ...
        <p>
        <p className="font-bold pt-4">Why Choose Jobi-Fy?</p>
        ...
        Unlock access to a diverse and highly skilled talent pool. Whether you're seeking seasoned professionals or rising stars, Jobi-Fy is where you'll find the perfect match for your team.
        ...
        At Jobi-Fy, we're not just a job board – we're your career partner. Explore our rich repository of resources, from expert career advice to skill-building opportunities, designed to help you grow personally and professionally.

        <p className="font-bold">Responsive Support Team:</p>
        Have questions or need assistance? Our dedicated support team is here for you. We pride ourselves on providing timely and personalized support to ensure your experience with Jobi-Fy is nothing short of exceptional.
        </p>
        <p className="font-bold pt-4">Thank you for choosing Jobi-Fy – Where Talent Meets Opportunity!</p>
      </div>
    </div>
  );
};
