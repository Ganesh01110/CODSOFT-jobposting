  ...
  return (
    <>
      <Transition appear show={open || false}>
        <Dialog as="div" className="relative z-10  bg-green-300" onClose={closeModal}>
          <Transition.Child
            as={Fragment}
          ...
          <div className="fixed inset-0 overflow-y-auto ">
            <div className="flex min-h-full items-center justify-center p-4 text-center ">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-green-300 p-6 text-left align-middle shadow-xl transition-all ">
                  <Dialog.Title
                    as="h3"
